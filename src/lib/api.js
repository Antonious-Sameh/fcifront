...
export const coursesAPI = {
  ...
  getVideos: (courseId) => apiFetch(`/courses/${courseId}/videos`),
  addVideo: (courseId, data) => apiFetch(`/courses/${courseId}/videos`, { method: 'POST', body: JSON.stringify(data) }),
  updateVideo: (courseId, videoId, data) => apiFetch(`/courses/${courseId}/videos/${videoId}`, { method: 'PUT', body: JSON.stringify(data) }),
